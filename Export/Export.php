...
namespace Xiranst\Bundle\DatabaseBundle\Export;
...
abstract class Export
{
    ...
    static function create($db_options) {
        $db = ExportDBConn::create($db_options);
        ...
        if (self::has_shell_access()
            ...
            $dumper = new ExportShellCommand($db);
        } else {
            $dumper = new ExportNative($db);
        }
    ...
    function __construct(ExportDBConn $db) {
        $this->db = $db;
    }
